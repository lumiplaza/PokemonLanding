const styles = {
  container: "min-h-screen bg-gradient-to-r from-blue-400 to-purple-600 p-8",
  ...
  button: "bg-yellow-500 text-white font-bold py-2 px-4 rounded disabled:opacity-50 mt-14 mx-auto block hover:bg-colorsearchbox",
};
